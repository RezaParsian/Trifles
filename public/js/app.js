...
window.$ = window.jquery = window.Jquery = window.jQuery = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
...
__webpack_require__(/*! ./jquery.meanmenu */ "./resources/js/jquery.meanmenu.js");

__webpack_require__(/*! ./jquery.appear.min */ "./resources/js/jquery.appear.min.js");

__webpack_require__(/*! ./odometer.min */ "./resources/js/odometer.min.js");
...
__webpack_require__(/*! ./jquery.nice-select.min */ "./resources/js/jquery.nice-select.min.js");

__webpack_require__(/*! ./imagelightbox.min */ "./resources/js/imagelightbox.min.js");

__webpack_require__(/*! ./jquery.ajaxchimp.min */ "./resources/js/jquery.ajaxchimp.min.js");

__webpack_require__(/*! ./form-validator.min */ "./resources/js/form-validator.min.js");

__webpack_require__(/*! ./contact-form-script */ "./resources/js/contact-form-script.js");
...
!function (t, e) {
  ...
  var q = {
    ...
    return n.next = function () {
      ...
      var t = this,
          e = function e(_e) {
        t._pointerEvent && tt[_e.pointerType.toUpperCase()] ? t.touchStartX = _e.clientX : t._pointerEvent || (t.touchStartX = _e.touches[0].clientX);
      },
          n = function n(e) {
  ...
  var nt = "collapse",
    ...
    return n.toggle = function () {
      ...
      var i = L(t, "bs.collapse"),
          o = s({}, it, q.getDataAttributes(t), "object" == _typeof(n) && n ? n : {});
    ...
    return n.toggle = function (t) {
      ...
      return this.each(function () {
        var i = L(this, "bs.modal"),
            o = s({}, _t, q.getDataAttributes(this), "object" == _typeof(t) && t ? t : {});
  ...
  var At = "tooltip",
    ...
    return a.enable = function () {
      ...
      if (null !== t) return "object" == _typeof(e) && g(e) ? (e.jquery && (e = e[0]), void (this.config.html ? e.parentNode !== t && (t.innerHTML = "", t.appendChild(e)) : t.textContent = e.textContent)) : void (this.config.html ? (this.config.sanitize && (e = kt(e, this.config.allowList, this.config.sanitizeFn)), t.innerHTML = e) : t.textContent = e);
    }, a.getTitle = function () {
  ...
  var Rt = "scrollspy",
    ...
    return n.refresh = function () {
      ...
      if ("string" != typeof (t = s({}, Kt, "object" == _typeof(t) && t ? t : {})).target && g(t.target)) {
        var e = t.target.id;
  ...
  var Ft = {
    ...
    return n.show = function () {
      ...
      return t = s({}, Yt, q.getDataAttributes(this._element), "object" == _typeof(t) && t ? t : {}), _("toast", t, this.constructor.DefaultType), t;
...
/***/ "./resources/js/imagelightbox.min.js":
/*!*******************************************!*\
  !*** ./resources/js/imagelightbox.min.js ***!
  \*******************************************/
...
(function (factory) {
  factory(( false ? 0 : _typeof(module)) === 'object' && _typeof(module.exports) === 'object' ? __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js") : jQuery, window, document);
  ...
  $.fn.imageLightbox = function (opts) {
    var targetSet = '',
      ...
      if (options.arrows) {
        ...
        _addQueryField = function _addQueryField(query, key, value) {
      ...
      return newQuery;
        ...
        _pushToHistory = function _pushToHistory() {
      ...
      window.history.pushState(newState, '', document.location.pathname + newQuery);
        ...
        _removeQueryField = function _removeQueryField(query, key) {
      var newQuery = query;
      ...
      return newQuery;
        ...
        _pushQuitToHistory = function _pushQuitToHistory() {
      if (!hasHistorySupport || !options.history) {
        return;
      }
      ...
      window.history.pushState({}, '', document.location.pathname + newQuery);
        ...
        _getQueryField = function _getQueryField(key) {
      ...
      return decodeURIComponent(keyValuePair[2].replace(/\+/g, ' '));
        ...
        _openHistory = function _openHistory() {
      if (!hasHistorySupport || !options.history) {
        return;
      }
      ...
      _openImageLightbox(element, !0);
        ...
        _popHistory = function _popHistory(event) {
      ...
      _loadImage(direction);
        ...
        _previousTarget = function _previousTarget() {
      targetIndex--;
      ...
      _loadImage(+1);
        ...
        _nextTarget = function _nextTarget() {
      targetIndex++;
      ...
      $wrapper.append($overlayObject);
        ...
        closeButtonOn = function closeButtonOn() {
      $buttonObject.appendTo($wrapper).on('click.ilb7', function () {
        ...
        captionReset = function captionReset() {
      ...
      if ($(target).data('ilb2-caption')) {
        ...
        navigationOn = function navigationOn() {
      if (!targets.length) {
        return;
      }
      ...
      $arrows.on('click.ilb7 touchend.ilb7', function (e) {
        ...
        isTargetValid = function isTargetValid(element) {
      ...
      tmpImage.onload = function () {
        ...
        _loadImage = function _loadImage(direction) {
      if (inProgress) {
        return !1;
      }
      ...
      image = $();
        ...
        _openImageLightbox = function _openImageLightbox($target, noHistory) {
      if (inProgress) {
        return !1;
      }
      ...
      _loadImage(0);
        ...
        _quitImageLightbox = function _quitImageLightbox(noHistory) {
      targetIndex = -1;
      ...
      image.animate({
        ...
        _addTargets = function _addTargets(newTargets) {
      ...
      function filterTargets() {
        ...
        _preloadVideos = function _preloadVideos(elements) {
    ...
    this.startImageLightbox = function (element) {
      if (element) element.trigger('click.ilb7');else $(this).trigger('click.ilb7');
    };
...
!function ($) {
  ...
  $.fn.meanmenu = function (e) {
    var n = {
      ...
      meanMenuContainer: ".trifles-responsive-menu",
      meanMenuClose: "X",
...
(function () {
  ...
  q = '<span class="odometer-value"></span>', n = '<span class="odometer-ribbon"><span class="odometer-ribbon-inner">' + q + "</span></span>", d = '<span class="odometer-digit"><span class="odometer-digit-spacer">8</span><span class="odometer-digit-inner">' + n + "</span></span>", g = '<span class="odometer-formatting-mark"></span>', c = "(,ddd).dd", h = /^\(?([^)]*)\)?(?:(.)(d+))?$/, i = 30, f = 2e3, a = 20, j = 2, e = .5, k = 1e3 / i, b = 1e3 / a, o = "transitionend webkitTransitionEnd oTransitionEnd otransitionend MSTransitionEnd", y = document.createElement("div").style, p = null != y.transition || null != y.webkitTransition || null != y.mozTransition || null != y.oTransition, w = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame, l = window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver, s = function s(a) {
    ...
    return a.prototype.renderInside = function () {
      ...
      if (this.digits = [], this.options.formatFunction) for (d = this.options.formatFunction(a), j = d.split("").reverse(), f = 0, h = j.length; h > f; f++) {
      ...
      } else for (e = !this.format.precision || !t(a) || !1, k = a.toString().split("").reverse(), g = 0, i = k.length; i > g; g++) {
